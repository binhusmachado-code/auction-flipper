...
class SampleDataScraper(BaseScraper):
    ...
    def scrape(self) -> List[ScrapedProperty]:
        print("📊 Generating enhanced sample data with current market patterns...")
        
        markets = [
            {"city": "Atlanta", "state": "GA", "price_range": (120000, 200000), "arv_mult": 1.9, "rehab_pct": 0.35},
            {"city": "Detroit", "state": "MI", "price_range": (40000, 100000), "arv_mult": 2.2, "rehab_pct": 0.45},
            {"city": "Houston", "state": "TX", "price_range": (150000, 280000), "arv_mult": 1.8, "rehab_pct": 0.30},
            {"city": "Phoenix", "state": "AZ", "price_range": (200000, 350000), "arv_mult": 1.6, "rehab_pct": 0.25},
            {"city": "Jacksonville", "state": "FL", "price_range": (80000, 160000), "arv_mult": 2.0, "rehab_pct": 0.40},
            {"city": "Cleveland", "state": "OH", "price_range": (60000, 140000), "arv_mult": 2.1, "rehab_pct": 0.42},
            {"city": "Memphis", "state": "TN", "price_range": (70000, 150000), "arv_mult": 1.9, "rehab_pct": 0.38},
            {"city": "Kansas City", "state": "MO", "price_range": (90000, 180000), "arv_mult": 1.8, "rehab_pct": 0.35},
            {"city": "Baton Rouge", "state": "LA", "price_range": (40000, 90000), "arv_mult": 2.3, "rehab_pct": 0.50},
            {"city": "Tucson", "state": "AZ", "price_range": (160000, 260000), "arv_mult": 1.7, "rehab_pct": 0.28},
        ]
        ...
        types = ["Street", "Avenue", "Drive", "Lane", "Road", "Boulevard", "Trail", "Way"]
...
def main():
    ...
    print()
    print("=" * 60)
    print("✅ Done! Import the JSON into your Auction Flipper app.")
    print("=" * 60)
