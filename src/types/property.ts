export interface Property {
  ...
  sellingAuthority?: string;
  legalDescription?: string;
  registrationDeadline?: string;
  paymentDeadline?: string;
  photoSource?: 'official_auction' | 'government_listing' | 'licensed_provider' | 'member_upload' | 'street_view' | 'unverified';
  photoSourceName?: string;
  photoSourceUrl?: string;
  photoCapturedAt?: string;
  photoVerifiedAt?: string;
  occupancySignal?: 'unknown' | 'vacant' | 'occupied' | 'possibly_occupied';
  accessStatus?: 'unknown' | 'verified' | 'concern';
  permitStatus?: 'unknown' | 'verified' | 'concern';
  utilityStatus?: 'unknown' | 'verified' | 'concern';
