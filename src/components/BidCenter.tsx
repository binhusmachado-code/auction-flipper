      ...
      <div className="grid gap-7 py-6 lg:grid-cols-[minmax(0,1fr)_280px]">
        <div className="min-w-0">
          ...
          <section className="border-t border-zinc-800 py-5" aria-labelledby="bid-limit-title">
            ...
            <div className="mt-3 flex flex-wrap gap-x-6 gap-y-2 text-xs"><span className="text-zinc-500">Opening bid <strong className="text-zinc-300">{money(property.openingBid ?? property.price)}</strong></span><span className="text-zinc-500">Estimated deposit <strong className="text-zinc-300">{money(depositEstimate)}</strong></span></div>
